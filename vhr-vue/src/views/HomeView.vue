<template>
  <div>
    <el-container>
      <el-header style="background-color: #1f2329;align-items: center;display: flex;justify-content: space-between">
        <div style="font-size: 30px">Home</div>
        <div>
          <el-dropdown style="cursor:pointer;" @command="menuHandle">
    <span class="el-dropdown-link" style="display: flex;align-items: center">
      {{ user.name }}
      <img :src="user.userface" style="width: 48px;height: 48px;border-radius: 24px" alt="">
    </span>
            <template #dropdown>
              <el-dropdown-menu>
      ...
      <el-container>
        ...
        <el-main>
          ...
          <div v-if="proxy.$router.currentRoute.value.path=='/home'" style="font-size: 35px;font-family: 华文行楷;color: red;text-align: center"></div>
          <RouterView/>
        </el-main>
      </el-container>
    </el-container>
